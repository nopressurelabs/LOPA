  ...
  initEvents = function() {
    $(".navbar-toggle").click(function() {
      if ($(".navbar-collapse").hasClass("collapse in")) {
        ...
        return $(".navbar-collapse").attr("aria-expanded", "false");
      } else {
        $(".navbar-collapse").addClass("collapse in");
        return $(".navbar-collapse").attr("aria-expanded", "true");
      }
    });
    return $(".radio-inline").click(function() {
      var elem;
      elem = $($(this).prev());
      if (elem.is("#do-subscribe")) {
        ...
        return $($("#do-not-subscribe").children()[0]).removeAttr("checked");
      } else {
        ...
        return $($("#do-not-subscribe").children()[0]).attr("checked", "checked");
      }
    });
  };
